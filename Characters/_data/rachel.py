...
SUMMARY = "Rachel is the member who has lasted the longest on Earth of all the team. She is an operator within the ICS command center, and oversees the occurring of events from there. In case of an emergency, she can take over control from the whole place from her terminal, and prevent everyone else from doing anything."

ABILITIES = "She can learn pretty much anything just by looking at it for a bit. She knows the human anatomy, and can fire focused energy bursts at specific parts to effectively quickly kill large groups of enemies. She can also restrict people's movements around her. She also ages much slower than the others while on Earth."
